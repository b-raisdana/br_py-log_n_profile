...
* 430de17 (HEAD -> main, origin/main, origin/feat/disable-NOT_TESTED-breakpoint, origin/HEAD, feat/disable-NOT_TESTED-breakpoint) style(config): reformat pre-commit configuration and update submodule
* 653e4b9
* a09e768 feat(do_log): disable breakpoint on NOT_TESTED message
* 869229f (origin/release/0.9.0, release/0.9.0) build: bump version to 0.9.0
* e11b6e6 (origin/feat/expose-NOT_TESTED-in-lib-root, feat/expose-NOT_TESTED-in-lib-root) feat(br_py_log_n_profile): expose NOT_TESTED in package root
* f81ed4e (origin/chore/test-logging-package-contracts, chore/test-logging-package-contracts) test(contract): add package contract tests
* 84edb82 (origin/release/0.8.0, release/0.8.0) chore(deps): update submodules br_pre_commit and br_pypi_publisher
* 64a7b75 chore(docs): update twine upload command in examples and migration guide
* a55bc10 build: bump version to 0.8.0
* b17de1c (origin/feat/log_exception-no-return, feat/log_exception-no-return) feat(do_log): update log_exception return type to NoReturn
...
* e11b6e6 (HEAD -> main, origin/main, origin/feat/expose-NOT_TESTED-in-lib-root, origin/HEAD, feat/expose-NOT_TESTED-in-lib-root) feat(br_py_log_n_profile): expose NOT_TESTED in package root
* f81ed4e (origin/chore/test-logging-package-contracts, chore/test-logging-package-contracts) test(contract): add package contract tests
* 84edb82 (origin/release/0.8.0, release/0.8.0) chore(deps): update submodules br_pre_commit and br_pypi_publisher
* 64a7b75 chore(docs): update twine upload command in examples and migration guide
* a55bc10 build: bump version to 0.8.0
